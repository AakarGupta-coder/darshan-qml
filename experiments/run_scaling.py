    ...
    for ds_name in datasets:
        ...
        for samples in sample_sizes:
            ...
            models = {
                ...
                'Ananta Pro': AnantaPro(n_qubits=n_features, head_search='fast', quantum_feature_seeds=(11,), callbacks=callbacks),
                'Samyoga Legacy': SamyogaLegacySVM(n_qubits=n_features, epochs_pretrain=config.get('epochs', 10), dataset_name=ds_name, tuning_mode='fast', callbacks=callbacks),
            ...
            for model_name, model in models.items():
                if existing_df is not None:
                    match = existing_df[(existing_df['Dataset'] == ds_name) & (existing_df['Model'] == model_name) & (existing_df['Train_Size'] == samples)]
                ...
                try:
                    ...
                    all_results.append({'Dataset': ds_name, 'Model': model_name, 'Train_Size': samples, 'Accuracy': res['accuracy'], 'AUC_ROC': res['auc_roc']})
